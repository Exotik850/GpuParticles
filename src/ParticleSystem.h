...
public:
    ...
    void update(float dt, ofVec2f mouse) {
        ...
        //m_computeShader.setUniform1f("maxForce", 25.0f);
        //m_computeShader.setUniform1f("maxSpeed", 10.0f);
...
private:
    ...
    struct Particle {
        ...
        Particle() :
            ...
            color(ofFloatColor(ofRandom(1.0f), ofRandom(1.0f), ofRandom(1.0f), 0.9f)) {}
    };
